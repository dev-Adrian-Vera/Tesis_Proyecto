    ...
    return [
        {
            ...
            "nombre_usuario": log.usuario.nombre_completo if log.usuario else "Desconocido",
            "email_usuario": log.usuario.email if log.usuario else "Desconocido"
    ...
    return [
        {
            ...
            "localizacion": i.meta_audio.localizacion if i.meta_audio else "No disponible",
